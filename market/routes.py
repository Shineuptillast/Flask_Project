    ...
    if request.method=="POST":
        ...
        if p_item_object :
            if current_user.can_purchase(p_item_object):
                ...
                flash(f"Budget isn't enough to purchase {p_item_object.name} for {p_item_object.price}",category="danger")
        # Sold Item logic
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"Congratulations! You sold {s_item_object.name} for {s_item_object.price} back to market!",
                      category="success")
            else:
